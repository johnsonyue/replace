...
def download_date(date, root_dir="download_iplane", proxy_file="", seg_size=20*1024*1024, mt_num=0):
...
download_date("20160710", proxy_file="proxy_list", seg_size=20*1024*1024, mt_num=10);
